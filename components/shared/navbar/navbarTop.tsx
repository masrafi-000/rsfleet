          ...
          <div className="flex items-center flex-1">
            <div className="flex gap-2 items-center px-4 border-r">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[12px] text-foreground font-medium">69 Lyalyalya St, Bishkek</span>
              </div>
            </div>
            <div className="flex gap-2 items-center px-4 border-r">
              <Clock className="size-4 text-muted-foreground" />
              <div className="flex flex-col">
                <span className="text-[11px] leading-tight">Working Hours:</span>
                <span className="text-[12px] text-foreground font-medium">8:00 AM - 10:00 PM, Daily</span>
              </div>
            </div>
          </div>
